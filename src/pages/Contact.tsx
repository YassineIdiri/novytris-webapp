        ...
        <div className="py-20 relative z-10 grid lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
            ...
            <p className="mt-6 text-lg text-slate-600 leading-relaxed">
              Vous avez un projet de développement ? Notre équipe vous répond sous 24h avec une première analyse de
              faisabilité et une proposition de roadmap détaillée.
            </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm mt-1">
                      Planifiez un rendez-vous de 30 minutes pour discuter de votre projet en détail.
                    </p>
                    <a
          ...
          >
            ...
            >
              ...
              {/* Honeypot anti-spam (doit rester présent) */}
              <p className="hidden">
                <label>
              ...
              >
                ...
                {status === "ok" && (
                  <>
                    Demande envoyée <CheckCircle className="w-5 h-5" />
                  </>
                )}
                {status === "err" && (
                  <>
                    Erreur, veuillez réessayer <AlertCircle className="w-5 h-5" />
                  </>
                )}
              </button>
